...
#[cfg(all(has_si5324, soc_platform = "kasli", any(hw_rev = "v2.0", hw_rev = "v2.1rc1", hw_rev = "v2.1")))]
const SI5324_EXT_INPUT: si5324::Input = si5324::Input::Ckin1;
#[cfg(all(has_si5324, soc_platform = "kasli", not(any(hw_rev = "v2.0", hw_rev = "v2.1rc1", hw_rev = "v2.1"))))]
