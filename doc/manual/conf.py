...
# -*- coding: utf-8 -*-
#
# ARTIQ documentation build configuration file, originally created by
# sphinx-quickstart on Thu Sep 18 16:51:53 2014.
#
# This file is execfile()d with the current directory set to its
# containing dir. All configuration values have a default; values that
# are commented out serve to show the default.
...
version_specific = {
    "|major_version|" : artiq_version.split('.')[0], # Major version number only
    "|channel|" : "beta", # Channel name (legacy, stable, beta)
    "|artiq_flake|": "git+https://git.m-labs.hk/M-Labs/artiq.git",
    "|extrapkg_flake|": "git+https://git.m-labs.hk/M-Labs/artiq-extrapkg.git",
    "|msys2_installer_link|": "https://nixbld.m-labs.hk/job/artiq/extra-beta/msys2-offline-installer/latest",
    "|msys2_server|": "https://msys2.m-labs.hk/artiq-beta"
}

def versioneer(app, docname, source):
...
project = 'ARTIQ'
copyright = '2014-2026, M-Labs Limited'
